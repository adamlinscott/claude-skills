...
That flag skips every checklist and applies the non-technical defaults. You still get the
Ready summary; nothing on disk changes until you confirm it, so read it before you accept.
